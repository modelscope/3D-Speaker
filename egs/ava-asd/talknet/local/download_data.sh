...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  python local/extract_video_clips.py --csv_ori $download_dir/csv/train_orig.csv --video_ori_dir $download_dir/orig_videos/trainval --video_out_dir $download_dir/clips_videos/train
  python local/extract_video_clips.py --csv_ori $download_dir/csv/val_orig.csv --video_ori_dir $download_dir/orig_videos/trainval --video_out_dir $download_dir/clips_videos/val
  python local/extract_video_clips.py --csv_ori $download_dir/csv/test_orig.csv --video_ori_dir $download_dir/orig_videos/test --video_out_dir $download_dir/clips_videos/test
fi
